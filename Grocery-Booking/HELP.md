...
* The original package name 'com. grocery.Grocery Booking' is invalid and this project uses 'com.grocery.Grocery.Booking' instead.
...
* [Docker Compose Support](https://docs.spring.io/spring-boot/docs/3.1.6/reference/htmlsingle/index.html#features.docker-compose)
